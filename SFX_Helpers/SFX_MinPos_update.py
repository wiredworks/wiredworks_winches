...
class SFX_OT_MinPos_update(bpy.types.Operator):
    bl_idname = "sfx.minpos_update"
    bl_label = "Update Min Pos"

    def invoke(self, context, event):
        if context.active_node.sfx_type == 'Actuator':
            HardMin     = sfx.actuators[context.active_node.name].Actuator_basic_props.Actuator_props.simple_actuator_HardMin_prop
            ...
            HardMin     = sfx.cues[context.active_node.name].Actuator_props.simple_actuator_HardMin_prop

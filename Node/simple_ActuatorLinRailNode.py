...
from .. exchange_data.simple_actuator_basic_props import simple_Actuator_basic_props
...
class simple_ActuatorLinRailNode(bpy.types.Node):
    ...
    #                                    update = update_value)
    Actuator_basic_props : bpy.props.PointerProperty(type = simple_Actuator_basic_props)
    ...
    def update(self):
        try:
            ...
            print(self.inputs["Set Vel"].set_vel)
            print(self.inputs["select_Act"].select)
            print(self.inputs["enable_Act"].enable)
            can_continue = True
        except:
            can_continue = False
        if can_continue:

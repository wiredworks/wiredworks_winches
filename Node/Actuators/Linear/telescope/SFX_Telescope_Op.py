...
class SFX_OT_Telescope_Op(bpy.types.Operator):
    ...
    def interact_with_3D_view(self):
        ...
        bpy.data.collections.get("ww SFX_Nodes").children[self.MotherNode.name].\
        objects[self.MotherNode.name+'_Out'].location.x = sfx.actuators[self.MotherNode.name].Actuator_basic_props.ist_Pos
        bpy.data.meshes[self.MotherNode.name].vertices[0].co.x = sfx.actuators[self.MotherNode.name].Actuator_basic_props.ist_Pos
        bpy.data.meshes[self.MotherNode.name].vertices[7].co.x = sfx.actuators[self.MotherNode.name].Actuator_basic_props.ist_Pos
        bpy.data.meshes[self.MotherNode.name].vertices[4].co.x = sfx.actuators[self.MotherNode.name].Actuator_basic_props.ist_Pos
        bpy.data.meshes[self.MotherNode.name].vertices[3].co.x = sfx.actuators[self.MotherNode.name].Actuator_basic_props.ist_Pos                

...
class SFX_SimpleRot_Node(bpy.types.Node):
    '''simple Rotational Actuator'''
    bl_idname = 'SFX_SimpleRot_Node'
    bl_label = 'simplerot'
    bl_icon = 'MESH_CIRCLE'
    ...
    sfx_actuator : bpy.props.PointerProperty(type = actuator_simplerot)
    ...
    def draw_model(self,name):
        self.SFX_drawModel.draw_model(name)
